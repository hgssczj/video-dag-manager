...
from . import DelayPredictModel as DelayPredictModel
...
class RuntimePortrait():
    ...
    def __init__(self, pipeline, user_constraint, serv_cloud_addr=None):
        ...
        for service in self.pipeline:
            ...
            cpu_edge_model_file = MODELS_PATH + "/" + service + "_cpu_edge.pth"
            cpu_server_model_file = MODELS_PATH + "/" + service + "_cpu_server.pth"
            ...
            mem_edge_model_file = MODELS_PATH + "/" + service + "_mem_edge.pth"
            mem_server_model_file = MODELS_PATH + "/" + service + "_mem_server.pth"
    ...
    def get_portrait_info(self):
        ...
        print('get_portrait_info准备开始计算精度, 当前精度是', acc_predicted )
