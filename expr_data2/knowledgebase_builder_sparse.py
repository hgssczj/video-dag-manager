...
if __name__ == "__main__":
    ...
    if need_sparse_kb==1:
        ...
        print("开算")
        if dec_rand==1:
            mem_comb_list_dec=kb_builder.get_comb_list_dec_rand( mem_range,len(serv_names))  #获取随机下降结果
        else:
            mem_comb_list_dec=kb_builder.get_comb_list_dec_max( mem_range,len(serv_names))  #每次下降取最大的
